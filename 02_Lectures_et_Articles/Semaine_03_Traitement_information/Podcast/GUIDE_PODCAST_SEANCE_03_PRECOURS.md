# 🎙️ Guide de la Capsule Audio Pré-Cours — Séance 3 (Traitement de l'Information)

* **Cours :** PSY9613 — Perception, cognition et intelligence artificielle (UQAM)
* **Date de la séance en classe :** Lundi 28 septembre 2026 (14h00 – 17h00)
...
## 🗺️ Articulation Thématique du Dialogue
1. **Entrée en matière & Le premier débat de la session :**
   - L'ouverture à 14h00 : Louis B (défendant le POUR) vs Alexandrea Kelly (défendant le CONTRE) sur le traitement de l'information.
   - Le rôle de Michel comme président modérateur selon les mots de Pierre Poirier : « un peu comme un avocat », cadencer les 5 à 10 minutes d'exposé, animer la table ronde et organiser le vote final de la classe.
2. **Le Socle Théorique (Mashour et al., 2021) :**
   - Le traitement modulaire spécialisé (inconscient, rapide, feedforward) vs l'Espace de Travail Neuronal Global (GNWT).
   - L'embrasement non-linéaire (*ignition*) vers ~300 ms (onde P3b) et la synchronisation fronto-pariétale.
   - La diffusion globale (*broadcasting*) permettant l'évaluation flexible, la verbalisation et l'action coordonnée.
3. **La Boîte à Outils pour Michel :**
   - Des pistes concrètes de relance pour animer la plénière et questionner la modularité vs l'intégration globale.
